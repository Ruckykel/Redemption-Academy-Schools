    ...
    <div className="w-full">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="w-full md:w-1/2 h-[400px] md:min-h-full order-1 md:order-2">
          ...
          <div className="w-full md:w-1/2 bg-blue-50 p-12 md:p-12 flex flex-col justify-center order-2 md:order-1">
